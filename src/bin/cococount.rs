...
fn main() {
    ...
    coco_file.annotations.iter().for_each(|annotation: &CocoAnnotation| match *annotation {
    ...
    coco_file.categories.unwrap_or_default().iter().for_each(|category| match category {
    ...
    println!("  Panoptic Segmentation Annotations: {}", annotation_counts[2]);
    ...
    println!("  Panoptic Segmentation Categories: {}", categories_count[1]);
